...
function Scene({
  ...
  const originRef = useRef<THREE.Object3D>(null);
  ...
  function ollie(board: THREE.Object3D) {
    jumpBoard(board);
  ...
  function kickflip(board: THREE.Object3D) {
    jumpBoard(board);
  ...
  function frontside360(board: THREE.Object3D, origin: THREE.Object3D) {
    jumpBoard(board);
  ...
  function jumpBoard(board: THREE.Object3D) {
    setAnimating(true);
